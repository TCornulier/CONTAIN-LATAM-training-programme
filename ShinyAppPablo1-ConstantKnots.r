#### GAM SHINY - M1: input number of knots and uniform weights
...
server<-function(input, output) {
    ...
    basis.coef<-runif(knots.N+2, -10, 10)		#### Initial coeffs drawn from a Uniform distribution
...
ui<-fluidPage(theme=shinytheme("flatly"),
  ...
  titlePanel("Generalised Additive Model Example: Random (Uniform) weights"),
